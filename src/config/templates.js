    ...
    pages: [
      {
        ...
        status: "doing",
        rfqStatus: "quotation",
        tags: ["rfq", "vendor", "urgent", "procurement", "quotation-deadline", "vendor-a"],
        markdown:
      ...
      },
      {
        ...
        status: "review",
        rfqStatus: "po-issued",
        tags: ["po", "delivery", "follow-up", "procurement", "delivery-schedule", "sparepart"],
        markdown:
      ...
      },
      {
        ...
        tags: ["vendor", "evaluation", "procurement", "vendor-evaluation", "service"],
        markdown:
      ...
      },
      {
        ...
        status: "ideas",
        rfqStatus: "request",
        tags: ["contract", "renewal", "procurement", "expired-contract", "renewal-agreement", "opex"],
        markdown:
